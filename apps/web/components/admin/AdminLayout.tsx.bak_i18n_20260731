...
const SIDEBAR_ITEMS = [
  ...
  { href: "/admin/nc-tool-master",label: "NC加工リストマスタ",   icon: "M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" },
  ...
  { href: "/admin/file-browser",   label: "ファイルブラウザ",     icon: "M3 7v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-6l-2-2H5a2 2 0 0 0-2 2z" },
];

const BOTTOM_ITEMS = ["/admin/pdf-editor", "/admin/special-sheets", "/admin/upload-agent", "/admin/file-browser"];
